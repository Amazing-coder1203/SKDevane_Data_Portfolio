export const features = [
  {
    ...
    caption: "About Me",
    title: "Building Scalable Python Systems",
    text: "Software Engineer with strong problem-solving skills and hands-on experience building scalable Python systems on Linux, automating financial data pipelines on AWS, and optimizing large-scale datasets. BTech Biotechnology student at DTU with a minor in Computer Science.",
    button: {
  ...
  },
  {
    ...
    title: "Insight Pipelines & Dashboards",
    text: "Specialized in Python, SQL, and Data Visualization to turn raw data into strategic insights. Experienced with exploratory data analysis, ETL processes, and creating interactive dashboards using Power BI and Tableau.",
    button: {
...
export const faq = [
  {
    ...
    answer:
      "I specialize in Python, C++, SQL, Linux, Bash scripting, and AWS (EC2, S3). I build scalable data pipelines and trading systems with focus on performance and reliability.",
  },
  {
    id: "1",
    question: "What industries have you analyzed data for?",
    answer:
      "I have analyzed diverse datasets across E-commerce, Finance, and Global Migration, uncovering trends that drive decision-making and business growth.",
  },
  {
    id: "2",
    question: "Can I see your live projects?",
    answer:
      "Absolutely! You can explore my Amazon Sales Analytics Dashboard, African Migration Conflict Analysis, and United Airlines Flight Analysis on my portfolio and GitHub.",
  },
  {
    id: "3",
    question: "What's your experience with AWS and Linux?",
    answer:
      "I've developed scalable data ingestion pipelines on AWS EC2, using bash scripts, Linux shell commands, and cron jobs for automation. I optimize large-scale datasets using Parquet formats.",
  },
  {
    id: "4",
    question: "What impact have your projects created?",
    answer:
      "My data cleaning and optimization workflows improved analysis speed by ~40% for large-scale datasets. I've also built automated reporting modules ensuring data integrity.",
  },
  {
    id: "5",
    question: "Do you have research or analytical experience?",
    answer:
      "Yes, I analyzed migration data across 42 African countries and completed data analytics simulations at Deloitte Australia, focusing on structured data analysis and insight generation.",
  },
  {
    id: "6",
    question: "Can I collaborate with you?",
    answer:
      "Yes, I'm open to internships, freelance projects, or collaborations in Data Science, Business Intelligence, and Statistical Modeling.",
  },
  {
    id: "7",
    question: "How do I contact you?",
    answer:
      "You can reach me at shivkumardevane47@gmail.com or connect via LinkedIn and GitHub links in my portfolio.",
  },
];
